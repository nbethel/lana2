...
function AddItem(Item : Transform){
	...
	//Item.gameObject.layer = LayerMask.NameToLayer("Ignore Raycast"); //Change item layer so that camera won't collide with it
...
function RemoveItem(Item : Transform){
	...
	//Item.gameObject.layer = LayerMask.NameToLayer("Default"); //Change item layer back to default
