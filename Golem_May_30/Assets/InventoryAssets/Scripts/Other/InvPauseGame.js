...
private var mouseLook1 : Behaviour;
private var mouseLook2 : Behaviour;
	...
	if (disableMouseLookComponent == true){
		if (ThePlayer != null && TheCamera != null){
			if (ThePlayer.GetComponent(MouseLook) != null && TheCamera.GetComponent(MouseLook) != null){
				mouseLook1 = ThePlayer.GetComponent(MouseLook);
				mouseLook2 = TheCamera.GetComponent(MouseLook);;
			}
		}
	}	
}
