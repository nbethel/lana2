...
var targetHeight = 0.0;                                                 // Vertical offset adjustment
var targetHeightOffset = 0.1;
...
var moveSpeed = 20; 
var rotationSpeed = 5;  
var myTransform : Transform;  //cam transform
 
private var golem : GameObject; 
...
function Start() {
		...
		//target = transform.Find("Golem/Body");
...
function Update(){
	...
	headBone = GameObject.Find("headBone");
		
	targetHeight = (headBone.transform.position.y * 0.1) - targetHeightOffset;
}
